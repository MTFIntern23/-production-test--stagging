...
class Performa_so_detail extends CI_Controller
{
    ...
    public function listdata()
    {
        ...
        $list = $this->so_detail_model->get_datatables($id, $params, $filter, $subfilter_decode);
        $data = array();
        $no = $_POST['start'];
    ...
    public function chartdata()
    {
        ...
        $list = $this->so_detail_chart_model->so_detail_chart($id, $params, $filter, $subfilter_decode);
        $data_fields = array();
        $data_values = array();
        foreach ($list as $field) {
    ...
    public function double_chartdata()
    {
        ...
        $list = $this->so_detail_chart_model->so_detail_chart($id, $params, $filter, $subfilter_decode);
        $list_2 = $this->so_detail_chart_model->so_detail_chart($id, $params2, $filter, $subfilter_decode);
        $data_fields1 = array();
        $data_values1 = array();
        $data_fields2 = array();
        $data_values2 = array();
