...
defined('BASEPATH') or exit('No direct script access allowed');
    class History_assets_jbrand_detail extends CI_Controller
    {
        public function __construct()
        {
            ...
            $this->load->model('serverside/strategi_penjualan/history_jbrand_detail_model');
        ...
        public function listdata(){
            ...
            $list = $this->history_jbrand_detail_model->get_datatables($id,$params);
            $data = array();
            $no = $_POST['start'];
            ...
            $output = array(
                "draw" => $_POST['draw'],
                "recordsTotal" => $this->history_jbrand_detail_model->count_all(),
                "recordsFiltered" => $this->history_jbrand_detail_model->count_filtered($id,$params),
                "data" => $data,
            );
