    ...
    class Performa_armo extends CI_Controller
    {
        ...
        public function index()
        {
            $data = [
                ...
                'performa_month_inside'=>$this->cabang_model->performa_armo('','curr_month_inside',false),
                'performa_month_outside'=>$this->cabang_model->performa_armo('','curr_month_outside',false),
                'performa_last_month'=>$this->cabang_model->performa_armo('','last_month',false),
                'performa_last_month_inside'=>$this->cabang_model->performa_armo('','last_month_inside',false),
                'performa_last_month_outside'=>$this->cabang_model->performa_armo('','last_month_outside',false),
