...
defined('BASEPATH') or exit('No direct script access allowed');
    class Cwo_monitoring extends CI_Controller
    {
        public function __construct()
        {
            ...
            $this->load->model('chart_filter/strategi_collection/cwo_monitoring_model');
        ...
        public function double_chartdata(){
            ...
            $list = $this->cwo_monitoring_model->cwo_monitoring_chart($params);
            $list_2 = $this->cwo_monitoring_model->cwo_monitoring_chart($params2);
            $list_3 = $this->cwo_monitoring_model->cwo_monitoring_chart($params3);
            $data_fields = array();
            $data_fields2 = array();
