            ...
            success: function(res) {
                ...
                chart_epd_monitoring_mtd_2.updateSeries([{
                    ...
                    name: 'EPD 8-30 (Akhir ' + month_name((new Date().getMonth())) +
                        ')',
                    type: 'column',
                    data: [(res.data_lending2).map(e => e = val_0_last).slice(0, (res
                        .data_fields).length)]
                }])
                chart_epd_monitoring_mtd_2.updateOptions({
                    ...
                    xaxis: {
                        categories: [(res.data_fields)[(res.data_fields).length - 1]].map(
                            dmyFormat),
                        tooltip: {
                            enabled: false
                        }
            ...
            success: function(res) {
                ...
                chart_epd_monitoring_mtd_3.updateSeries([{
                    ...
                    name: 'EPD 8-30 (Akhir ' + month_name((new Date().getMonth())) +
                        ')',
                    type: 'column',
                    data: [(res.data_lending2).map(e => e = val_1_last).slice(0, (res
                        .data_fields).length)]
                }])
