...
<div class="container-xxl flex-grow-1 container-p-y">
    <h5 class="fw-bold text-warning py-3 mb-4"><span class="text-muted fw-light">Strategi Penjualan /</span>
        <span class="text-muted fw-light">Performa Product /</span> Performa Product Detail
    </h5>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <h5 class="card-header text-dark fs-4 text-start" style="margin-bottom: -30px;">
                    ...
                    <p style="font-size: 38px;margin-top:10px;">
                        <b><?= $performa_product_month[0]->gp;?></b>
                    </p>
                </h5>
                <!-- button -->
...
<script async>
    ...
    var chart_performa_produk_detail_mtd_2 = new ApexCharts(document.querySelector(
            "#performa_produk_detail_mtd_chart_2"),
    ...
    var chart_performa_produk_detail_ytd_2 = new ApexCharts(document.querySelector(
            "#performa_produk_detail_ytd_chart_2"),
...
<script defer>
    ...
    $(document).ready(function() {
        $.ajax({
            ...
            data: {
                'id_gp': <?= $performa_product_month[0]->id_gp;?> ,
                'params': 'curr_month',
                'params2': 'curr_year'
            },
            dataType: "json",
            success: function(res) {
                chart_performa_produk_detail_mtd_2.updateSeries((res.data_total).map(e => parseInt(
                    e)))
                ...
                chart_performa_produk_detail_ytd_2.updateSeries((res.data_total2).map(e => parseInt(
                    e)))
        ...
        product_detail_mtd = $('#performa_produk_detail_mtd').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: {
                    'id_product': <?= $performa_product_month[0]->id_gp;?> ,
                    'params': 'curr_month'
                },
                datatype: "json"
            },
