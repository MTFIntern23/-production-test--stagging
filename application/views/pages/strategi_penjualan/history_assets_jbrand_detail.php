        ...
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <h5 class="card-header text-dark fs-4 text-start" style="margin-bottom: -30px;">
                    ...
                    <p style="font-size: 38px;margin-top:10px;"><img class="me-2" src="https://upload.wikimedia.org/wikipedia/commons/9/9a/Mitsubishi_motors_new_logo.svg"
                            alt="Mitsubishi" width="40" height="40"><b>Mitsubishi</b></p>
                </h5>
                <!-- button -->
