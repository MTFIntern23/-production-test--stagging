...
<div class="container-xxl flex-grow-1 container-p-y">
    <h5 class="fw-bold text-warning py-3 mb-4"><span class="text-muted fw-light">Strategi Penjualan /</span>
        <span class="text-muted fw-light">History Assets /</span> History Assets Detail
    </h5>
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                ...
                <h5 class="card-header text-dark fs-4 text-start" style="margin-bottom: -30px;">
                    ...
                    <p style="font-size: 38px;margin-top:10px;">
                        <b><?= $history_assets_month[0]->tipe;?></b>
                    </p>
                </h5>
                <!-- button -->
...
<script defer>
    ...
    $(document).ready(function() {
        $.ajax({
            ...
            data: {
                'id': <?= $history_assets_month[0]->id_tipe;?> ,
                'tipe': 'tipe',
                'params': 'curr_month'
            },
            dataType: "json",
        ...
        history_detail_mtd = $('#history_assets_mtd').DataTable({
            ...
            ajax: {
                ...
                type: "POST",
                data: {
                    'id_tipe': <?= $history_assets_month[0]->id_tipe;?> ,
                    'params': 'curr_month'
                },
                datatype: "json"
            },
