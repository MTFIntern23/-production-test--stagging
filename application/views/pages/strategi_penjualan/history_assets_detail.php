            ...
            <div class="card mb-4">
                ...
                <div id="chart_mtd" class="d-none">
                    ...
                    <div class="ms-4 me-4 mb-4">
                        <table id="history_assets_mtd" class="table table-striped table-hover display nowrap"
                            style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                ...
                <div id="chart_ytd" class="d-none">
                    ...
                    <!-- datatables -->
                    <div class="ms-4 me-4 mb-4">
                        <table id="history_assets_ytd" class="table table-striped table-hover display nowrap"
                            style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
...
<!-- ==================== -->
<script defer>
    var history_detail_mtd,history_detail_ytd
    $(document).ready(function () {
        $.ajax({
            type:"POST",
            url: '<?php echo base_url(); ?>/strategi_penjualan/history_assets_detail/chartdata',
            data:{'id':<?= $history_assets_month[0]->id_tipe;?>,'tipe':'tipe','params':'curr_month'},
            dataType: "json",
        ...
        $.ajax({
            ...
            data:{'id':<?= $history_assets_month[0]->id_tipe;?>,'tipe':'tipe','params':'curr_year','params2':'last_year'},
            dataType: "json",
            success: function(res){
        ...
        history_detail_mtd=$('#history_assets_mtd').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            info: true,
            ...
            ajax: {
                url: '<?php echo base_url(); ?>/strategi_penjualan/history_assets_detail/listdata',
                type: "POST",
                data:{'id_tipe':<?= $history_assets_month[0]->id_tipe;?>,'params':'curr_month'},
                datatype: "json"
            },
            columnDefs: [
                { 
        ...
        history_detail_ytd=$('#history_assets_ytd').DataTable({
            processing: true,
            serverSide: true,
            searching: true,
            info: true,
            ...
            ajax: {
                url: '<?php echo base_url(); ?>/strategi_penjualan/history_assets_detail/listdata',
                type: "POST",
                data:{'id_tipe':<?= $history_assets_month[0]->id_tipe;?>,'params':'curr_year'},
                datatype: "json"
            },
            columnDefs: [
                { 
