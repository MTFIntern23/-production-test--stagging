...
class Dealer_detail_model extends CI_Model{
    ...
    private function _dealer_detail($id,$params){
        ...
        $this->db->select(''.$this->_table_dl.'.id_dealer,'.$this->_table_dl.'.id_cabang,'.$this->_table_dl.'.id_pic,'.$this->_table_agreement.'.id_customer,
            ...
            '.$this->_table_dl.'.kecamatan AS kecamatan_dealer, '.$this->_table_dl.'.kelurahan AS kelurahan_dealer, '.$this->_table_cbg.'.`nama_cabang`,'.$this->_table_pic.'.`nama_pic`,'.$this->_table_pic.'.`no_telp`,'.$this->_table_pic.'.`jabatan`,'.$this->_table_agreement.'.`no_aplikasi`,'.$this->_table_agreement.'.`tgl_appin`, '.$this->_table_agreement.'.`tgl_golive`,'.$this->_table_agreement.'.`lending_amt`, '.$this->_table_cst.'.`nama_cust`,'.$this->_table_cst.'.`kecamatan_cust`,'.$this->_table_cst.'.`pendidikan_cust`,'.$this->_table_pfs.'.`profesi` AS profesi_cust,'.$this->_table_so.'.`nama_so`,'.$this->_table_jns.'.`jenis`,'.$this->_table_bd.'.`brand`');
