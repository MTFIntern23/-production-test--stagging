...
class Product_model extends CI_Model{
    ...
    var $column_order = array(null, 'gp','mtd_amt','mtd_unit',null); 
    var $column_search = array('gp'); 
    var $order = array('gp' => 'asc'); 
    private function _product($params){
