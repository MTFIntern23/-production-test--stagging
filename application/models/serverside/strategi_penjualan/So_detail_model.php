...
class So_detail_model extends CI_Model{
    ...
    var $column_order = array(null, 'no_aplikasi','nama_cust','lending_amt','tgl_appin','tgl_golive','jenis','nama_dealer'); 
    var $column_search = array('no_aplikasi','nama_cust','lending_amt','tgl_appin','tgl_golive','jenis','nama_dealer'); 
    var $order = array('tgl_golive' => 'desc'); 
    private function _so_detail($id,$params){
