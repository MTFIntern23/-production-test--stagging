...
class Tod_monitoring_model extends CI_Model{
    ...
    var $column_order = array(null, 'no_aplikasi','nama_cust','lending_amt','tgl_appin','tgl_golive','nama_so','nama_armo','od','osp','instalment_amt','instalment_number','tenor'); 
    var $column_search = array('no_aplikasi','nama_cust','lending_amt','tgl_appin','tgl_golive','nama_so','nama_armo','od','osp','instalment_amt','instalment_number','tenor'); 
    var $order = array('tgl_golive' => 'desc'); 
    private function _tod_monitoring($id,$params){
    ...
    {
        $this->db->cache_on();
        $this->_tod_monitoring($id,$params);
        if($_POST['length'] != -1)
